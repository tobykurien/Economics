# Sample code from the book "Exploring Everyday Things with R and Ruby" by Sau Sheong Chang
# @see http://shop.oreilly.com/product/0636920022626.do
...
class Float
  ...
  def round(num=nil)
    round_old() if num == nil
    format("%0.#{num}f", self).to_f
  end
end
